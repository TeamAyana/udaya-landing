...
export function RichTextEditor({ content, onChange, placeholder }: RichTextEditorProps) {
  ...
  const addImage = () => {
    alert('Image functionality is temporarily disabled')
  ...
  const uploadImage = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Image upload successful but display is temporarily disabled')
      }
    } catch (error) {
  ...
  const addYoutubeVideo = () => {
    alert('YouTube functionality is temporarily disabled')
  ...
  const insertTable = () => {
    ...
    alert('Table functionality is temporarily disabled')
  }
  ...
  const setFontFamily = (font: string) => {
    ...
    alert('Font family functionality is temporarily disabled')
              ...
              <div className="flex flex-wrap gap-1">
                {['yellow', 'green', 'blue', 'pink', 'purple'].map(color => (
                  <button
                    ...
                    style={{ backgroundColor: color === 'yellow' ? '#FFFF00' : color }}
                  >
                    {color}
                  </button>
                ))}
