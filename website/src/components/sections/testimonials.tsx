        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-6 sm:mt-8">
            ...
            <div className="relative overflow-hidden">
              ...
              >
                <blockquote className="text-[clamp(1.25rem,3.5vw,1.75rem)] font-serif italic text-udaya-charcoal px-4 leading-[1.4] font-normal">
                  "{testimonials[currentIndex].quote}"
                </blockquote>
                <p className="mt-4 sm:mt-6 text-[14px] sm:text-[15px] text-udaya-charcoal/65 font-normal">
