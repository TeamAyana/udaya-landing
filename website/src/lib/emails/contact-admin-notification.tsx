                ...
                <tr>
                  <td style={{ padding: '32px 40px' }}>
                      ...
                      <tr>
                        <td style={{ padding: '12px 0' }}>
                          <table width="100%" cellPadding="0" cellSpacing="0">
                            <tr>
                              <td width="40%">
                                <strong style={{ color: '#7fa99b', fontSize: '13px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>User Type</strong>
                              </td>
                              <td>
                                <span style={{ fontSize: '15px', color: '#2B2B2B' }}>{userTypeLabel}</span>
                              </td>
                            </tr>
                          </table>
                        </td>
                    ...
                    <div style={{
                      ...
                      <p style={{ margin: 0, fontSize: '15px', color: '#2B2B2B', fontWeight: '500' }}>
                        {subject}
                      </p>
                    </div>
                    ...
                    <table width="100%" cellPadding="0" cellSpacing="0" style={{ marginBottom: '24px' }}>
                      <tr>
                        ...
                        <td style={{ paddingBottom: '12px' }}>
                          <a href={`https://mail.google.com/mail/?view=cm&fs=1&to=${email}&su=Re: ${subject}`} style={{
                            display: 'inline-block',
                            padding: '14px 24px',
                            backgroundColor: '#ffffff',
                            color: '#7fa99b',
                ...
                <tr>
                  <td style={{
                    ...
                    <p style={{
                      ...
                      This is an automated notification from Udaya's contact form system.
                    </p>
                    <p style={{
                      margin: '12px 0 0 0'
                    }}>
